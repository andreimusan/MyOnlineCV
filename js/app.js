...
// // carousel 2
// function carousel2(){
//     let itemClassName = "carousel-photo2",
//         items = document.getElementsByClassName(itemClassName),
//         totalItems = items.length,
//         slide = 0,
//         moving = true;
...
//     // Set event listeners
//     function setEventListeners() {
//         let next = document.getElementsByClassName('carousel-button-next2')[0],
//             prev = document.getElementsByClassName('carousel-button-prev2')[0];
